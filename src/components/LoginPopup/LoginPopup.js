...
export default function LoginPopup(props) {
    const [forgetPopupSec,setForgetPopupSec]=useState(false);
    function forgetPopup(){
        setForgetPopupSec(true)
    }
    function backToLoginPopup(){
        setForgetPopupSec(false)
    }
  return (
    <>
                            ...
                            <div className="tab-content" id="nav-tabContent">
                                        ...
                                        <div className='login_form_sec'>
                                            <form className="row g-3 form_sec">
                                                ...
                                                <div className="col-12 forget_link">
                                                    <Link className="" to="#" onClick={forgetPopup}> Forgot your password? </Link>
                                                </div>
                                ...
                                <div className={`tab-pane fade ${props.login ? "show active" : ""}`} id="nav-profile" role="tabpanel" aria-labelledby="nav-profile-tab">
                                    <div className='login_sec'>
                                        ...
                                        <div className='social_login'>
                                            <button className='social_login_btn g_btn'><img src="./assets/icons/g_btn.png"/> Sign Up with Google</button>
                                            <button className='social_login_btn f_btn'><img src="./assets/icons/f_btn.png"/> Sign Up with Facebook</button>
                                        </div>
                                        <div className='or_sec'>Or</div>
                                        <div className='login_form_sec'>
                                            <form className="row g-3 form_sec">
                                                <div className="col-md-12">
                                                    <input type="text" className="form-control" name="loginEmail" placeholder='Email'/>
                                                </div>
                                                <div className="col-md-12">
                                                    <input type="email" className="form-control" name="loginEmail" placeholder='Email'/>
                                                </div>
                                                ...
                                                <div className="col-12">
                                                    <button className="btn form_submit" type="submit">Sign Up</button>
                                                </div>
                                            </form>
                                            <div className="col-12 forget_link">
                                                    <p>By signing up you agree to the <Link className="" to="/terms-and-conditions">Terms of Service</Link> & <Link className="" to="/privacy-policy">Privacy Policy</Link> of Snappershot.</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
